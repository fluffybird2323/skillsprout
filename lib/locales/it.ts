export default {
  ...
  splash: {
    ...
    tagline: "L'IA progetterà il tuo viaggio."
  },
  auth: {
    signIn: "Accedi",
    signOut: "Esci",
    ...
    welcomeToast: "Benvenuto! Creiamo il tuo primo corso 🎉",
    error: "Qualcosa è andato storto - riprova",
    welcome: "Benvenuto su Manabu",
    subtitle: "I tuoi corsi e i tuoi progressi sono salvati per sempre",
    createTab: "Crea account",
    signInTab: "Accedi",
    username: "Nome utente",
    email: "Email",
    passwordHint: "Deve contenere almeno 6 caratteri",
    signInButton: "Accedi",
    createButton: "Crea account e inizia a imparare"
  },
  common: {
    loading: "Caricamento...",
    initializing: "Costruendo un percorso",
    error: "Errore",
    retry: "Riprova",
    cancel: "Annulla",
    continue: "Continua",
  ...
  lesson: {
    ...
    tip: "Suggerimento:",
    revisionRound: "Turno di revisione",
    completeSubtitle: "Continua così",
    accuracy: "Precisione",
    streak: "Serie giornaliera",
    lessonFailed: "Lezione fallita",
    failedDescription: "Troppe risposte errate. Rivedi il materiale e riprova.",
  ...
  roadmap: {
    ...
    completeToExtend: "Completa il percorso per estendere",
